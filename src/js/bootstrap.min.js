  ...
  if ((b[0] < 2 && b[1] < 9) || (1 == b[0] && 9 == b[1] && b[2] < 1) ||
    ...
    +(function(a) {
      ...
      (a.fn.alert = b), (a.fn.alert.Constructor = d),
          (a.fn.alert.noConflict =
               function() { return (a.fn.alert = e), this; }),
    ...
    +(function(a) {
      ...
      (a.fn.button = b), (a.fn.button.Constructor = c),
          (a.fn.button.noConflict =
               function() { return (a.fn.button = d), this; }),
          a(document)
    ...
    +(function(a) {
      ...
      var c = function(b, c) {
        (this.$element = a(b)),
            ...
            this.options.keyboard &&
                this.$element.on("keydown.bs.carousel",
      ...
      (a.fn.carousel = b), (a.fn.carousel.Constructor = c),
          (a.fn.carousel.noConflict =
               function() { return (a.fn.carousel = d), this; });
      var e = function(c) {
        var d, e = a(this),
    ...
    +(function(a) {
      ...
      (d.VERSION = "3.3.7"), (d.TRANSITION_DURATION = 350),
          (d.DEFAULTS = {toggle : !0}), (d.prototype.dimension = function() {
            ...
            if (!this.transitioning && !this.$element.hasClass("in")) {
              var b,
                  e = this.$parent && this.$parent.children(".panel").children(
                                          ".in, .collapsing");
              if (!(e && e.length &&
      ...
      (a.fn.collapse = c), (a.fn.collapse.Constructor = d),
          (a.fn.collapse.noConflict =
               function() { return (a.fn.collapse = e), this; }),
    ...
    +(function(a) {
      ...
      function b(b) {
        ...
        c || ((c = b.attr("href")), (c = c && /#[A-Za-z]/.test(c) &&
                                         c.replace(/.*(?=#[^\s]*$)/, "")));
        var d = c && a(c);
    ...
    +(function(a) {
      ...
      var c = function(b, c) {
        (this.options = c), (this.$body = a(document.body)),
            (this.$element = a(b)),
      ...
      (a.fn.modal = b), (a.fn.modal.Constructor = c),
          (a.fn.modal.noConflict =
               function() { return (a.fn.modal = d), this; }),
    ...
    +(function(a) {
      ...
      var c = function(a, b) {
        (this.type = null), (this.options = null), (this.enabled = null),
            ...
            (this.$element = null), (this.inState = null),
        ...
        viewport : {selector : "body", padding : 0},
          ...
          (c.prototype.init = function(b, c, d) {
            ...
            if ((c || ((c = new this.constructor(b.currentTarget,
                 ...
                 !c.isInStateTrue()))
              return (clearTimeout(c.timeout), (c.hoverState = "out"),
            ...
            isNaN(g) && (g = 0), isNaN(h) && (h = 0), (b.top += g),
                (b.left += h),
            ...
            if (!this.$viewport)
              return e;
            var f = (this.options.viewport && this.options.viewport.padding) ||
                    0,
            ...
            return (a = b.attr("data-original-title") ||
                        ("function" == typeof c.title ? c.title.call(b[0])
                                                      : c.title));
      ...
      (a.fn.tooltip = b), (a.fn.tooltip.Constructor = c),
          (a.fn.tooltip.noConflict =
               function() { return (a.fn.tooltip = d), this; });
    })(jQuery),
    +(function(a) {
      "use strict";
      function b(b) {
      ...
      (a.fn.popover = b), (a.fn.popover.Constructor = c),
          (a.fn.popover.noConflict =
               function() { return (a.fn.popover = d), this; });
    })(jQuery),
    +(function(a) {
      "use strict";
      function b(c, d) {
      ...
      (b.VERSION = "3.3.7"), (b.DEFAULTS = {offset : 10}),
          (b.prototype.getScrollHeight = function() {
            ...
            var c = this.selector + '[data-target="' + b + '"],' +
            ...
            function f() {
              g.removeClass("active")
                  ...
                  b.addClass("active")
                      .find('[data-toggle="tab"]')
                      .attr("aria-expanded", !0),
                  h ? (b[0].offsetWidth, b.addClass("in"))
                    : b.removeClass("fade"),
    ...
    +(function(a) {
      ...
      (c.VERSION = "3.3.7"), (c.RESET = "affix affix-top affix-bottom"),
          ...
          (c.prototype.getState = function(a, b, c, d) {
            ...
            if (this.$element.is(":visible")) {
              var b = this.$element.height(), d = this.options.offset,
                  e = d.top, f = d.bottom,
      ...
      (a.fn.affix = b), (a.fn.affix.Constructor = c),
          (a.fn.affix.noConflict =
               function() { return (a.fn.affix = d), this; }),
          a(window).on("load", function() {
